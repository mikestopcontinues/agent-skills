---
name: write-doc
description: "Author or edit any document under docs/. Use for new chapter authoring, single-section edits, frontmatter touch-ups, or restructuring existing docs. Replaces edit-doc."
---
...
shapes MUST be created via the `${CLAUDE_PLUGIN_ROOT}/scripts/yolo new` CLI:

| New file shape | Scaffold |
|----------------|----------|
| `docs/spikes/sNNN-<name>/README.md` | `${CLAUDE_PLUGIN_ROOT}/scripts/yolo new spike <project> <name>` |
| `docs/plans/pNNN-<name>/README.md` | `${CLAUDE_PLUGIN_ROOT}/scripts/yolo new plan <project> <name>` |
| `docs/notes/<name>.md` (top-level note) | `${CLAUDE_PLUGIN_ROOT}/scripts/yolo new note --global <name>` |
...
it. Project-scope notes use `${CLAUDE_PLUGIN_ROOT}/scripts/yolo new note <project-slug> <name>` instead
of `--global`.
...
- If cross-references changed, run `${CLAUDE_PLUGIN_ROOT}/scripts/doc-check-links.sh`
