...
1. **Resolve the focus brief.** `Read` `focuses/{focus}.md` (co-located with this skill).
   ...
   improvise one.)
2. **Adopt the persona.** `Read` `personas/{persona}.md` (co-located with this skill) — the persona is
