---
name: create-note
description: "Create a living note — for unresolved decisions, working knowledge, and adapter contracts that don't fit a spike or plan. Use when capturing design context that needs a home but isn't research or a spec."
---
