---
name: validate-code
description: "Code review dispatcher — fans out per-focus review-code subagents in parallel against a code artifact (diff, file, or directory) and returns a summary. Called by write-code, execute-plan, and ad-hoc by the captain."
---
...
(`.claude/skills/review-code/focuses/<focus>.md`), adopts the persona that brief
