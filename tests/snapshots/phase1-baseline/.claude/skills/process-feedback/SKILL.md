...
description: "Per-cluster feedback handler. Reads one cluster + artifact + relevant rNN- review files, deep-dives ambiguous clusters against primary sources, and emits exactly one of two canonical verdict shapes — verified-resolution or narrowed-options-brief. Subagent; no Dispatch."
