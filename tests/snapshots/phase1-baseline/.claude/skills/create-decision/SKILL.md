...
description: "Capture a locked decision as a numbered dNN-<name>.md file. Use when the captain has answered a load-bearing question that should outlive the conversation, or when lock-decisions / grill-me hands off a captain-locked answer for persistence. Lightweight — no review cycle."
---
