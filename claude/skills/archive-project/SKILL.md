...
3. If promote: invoke `/create-decision --global <name>` style flow
   (or directly scaffold via `${CLAUDE_PLUGIN_ROOT}/scripts/yolo new decision
...
3. If move: scaffold via `${CLAUDE_PLUGIN_ROOT}/scripts/yolo new note --global
