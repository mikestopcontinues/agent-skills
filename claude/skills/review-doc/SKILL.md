...
1. **Resolve the focus brief.** `Read` `${CLAUDE_PLUGIN_ROOT}/skills/review-doc/focuses/{focus}.md`.
   ...
   improvise one.)
2. **Adopt the persona.** `Read` `${CLAUDE_PLUGIN_ROOT}/agents/{persona}.md` — the persona is
